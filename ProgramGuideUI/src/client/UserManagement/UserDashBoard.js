...
class UserDashboard extends Component {
    ...
    render() {
        return (
            !this.props.storeData._userDashboardData
                ? <Loader />
                : <div className="itemDiv add-users__wrapper">
                    <div className="container">
                        ...
                        <ReactTable
                            data={this.props.storeData._userDashboardData}
                            minRows={0}
                            columns={[
                                {
                                    Header:
...
export default connect((state, props) => { return { storeData: state } })(UserDashboard);
